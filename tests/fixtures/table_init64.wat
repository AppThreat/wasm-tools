(module
  ...
  (table $t2 (;2;) i64 30 30 funcref)
  (export "test" (func 10))
  (export "check" (func 11))
  (elem (;0;) (table $t2) (i64.const 2) func 3 1 4 1)
  (elem (;1;) funcref (ref.func 2) (ref.func 7) (ref.func 1) (ref.func 8))
  (elem (;2;) (table $t2) (i64.const 12) func 7 5 2 3 6)
  ...
  (func (;11;) (type 2) (param i64) (result i32)
    local.get 0
    call_indirect $t2 (type 0)
  )
)
